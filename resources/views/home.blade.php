...
$("document").ready(function(){  
    ...
    function load_chat_data(l, s,conversationid){
            $.post('{{ route('admin.chatting.show') }}', {_token:'{{ @csrf_token() }}',conversation_id:conversationid, limit:l,start:s}, function(data){
    ...
    function refresh_contacts(){
        $.post('{{ route('admin.chatting.refresh_contacts') }}', {_token:'{{ @csrf_token() }}'}, function(data){
    ...
    $(document).on('click','.user-list-box .person', function(event) {
        if ($(this).hasClass('.active')) {
            ...
            $.post('{{ route('admin.chatting.show') }}', {_token:'{{ @csrf_token() }}',conversation_id:conversationid}, function(data){
    ...
    $('.mail-write-box').on('keydown', function(event) {
        if(event.key === 'Enter') {
            ...
            $.post('{{ route('admin.chatting.send') }}', {_token:'{{ @csrf_token() }}', message:chatMessageValue, conversation_id:conversationid}, function(data){
                console.log(data);
            });
            const getScrollContainer = document.querySelector('.chat-conversation-box');
