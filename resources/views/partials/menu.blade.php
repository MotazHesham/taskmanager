    ...
    <ul class="c-sidebar-nav">
        ...
        @can('user_management_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/permissions*") ? "c-show" : "" }} {{ request()->is("admin/roles*") ? "c-show" : "" }} {{ request()->is("admin/users*") ? "c-show" : "" }}">
                ...
                <ul class="c-sidebar-nav-dropdown-items" style="@if(app()->getLocale() == 'ar') padding-right: 8%; @else padding-left: 8%; @endif" style="@if(app()->getLocale() == 'ar') padding-right: 8%; @else padding-left: 8%; @endif">
        ...
        @can('task_management_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/task-statuses*") ? "c-show" : "" }} {{ request()->is("admin/task-tags*") ? "c-show" : "" }} {{ request()->is("admin/tasks*") ? "c-show" : "" }} {{ request()->is("admin/tasks-calendars*") ? "c-show" : "" }}">
                ...
                <ul class="c-sidebar-nav-dropdown-items" style="@if(app()->getLocale() == 'ar') padding-right: 8%; @else padding-left: 8%; @endif">
                    @can('task_access')
                        <li class="c-sidebar-nav-item">
